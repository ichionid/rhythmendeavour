...
public final class midiWrite implements JMC{
       /**
        * 
        * @param args, is a <code>String</code> that contains as a first
        *   field the name of the midi file that will store the results in.
        * @param rhythm, is a <code>Vector<String></code> that contains the rhythm.
        *   
        */ 
	public static void main(String[] args, Vector<String> rhythm){
